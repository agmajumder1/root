...
for fn in files:
	...
	apiname = []
	value = []
	for api in root.findall("./{http://soap.sforce.com/2006/04/metadata}validationRules"):
		if api.find("{http://soap.sforce.com/2006/04/metadata}fullName") is not None:
			if api.find("{http://soap.sforce.com/2006/04/metadata}errorMessage") is not None:
	...
	#for val in root.findall("./{http://soap.sforce.com/2006/04/metadata}fields/{http://soap.sforce.com/2006/04/metadata}"):
				value.append(api.find("{http://soap.sforce.com/2006/04/metadata}errorMessage").text)
	...
	for f in transfiles:
		...
		if transrawname == fnrawname:
			with open('./output/Validation Error Message Translations/'+fi+'_TranslationUtilityOutput.csv','w') as f1:
				...
				for transapi in root.findall("./{http://soap.sforce.com/2006/04/metadata}validationRules"):
					if transapi.find("{http://soap.sforce.com/2006/04/metadata}name") is not None:
						if transapi.find("{http://soap.sforce.com/2006/04/metadata}errorMessage") is not None:
				...
				#for val in root.findall("./{http://soap.sforce.com/2006/04/metadata}fields/{http://soap.sforce.com/2006/04/metadata}"):
							transvalnamelist.append(transapi.find("{http://soap.sforce.com/2006/04/metadata}errorMessage").text)
